namespace ShinobiZero.Core
{
    public struct GamePreferences
    {
        ...
        public readonly int AimSensitivityStep;

        public GamePreferences(bool soundEnabled, bool hapticsEnabled, bool reducedMotion, bool englishUi = false, bool fullscreen = true, int volumeStep = 8, int aimSensitivityStep = 5)
        {
            ...
            AimSensitivityStep = System.Math.Max(0, System.Math.Min(10, aimSensitivityStep));
        }

        public float AimSensitivityMultiplier { get { return 0.5f + AimSensitivityStep * 0.1f; } }
    ...
    public static class PreferencesCodec
    {
        ...
        private const int VolumeVersionFlag = 1 << 10;
        private const int VersionFlag = 1 << 15;
        private const int VolumeShift = 11;
        private const int AimSensitivityShift = 16;
        ...
        public static int Encode(GamePreferences value)
        {
            return VersionFlag | (value.SoundEnabled ? 1 : 0) | (value.HapticsEnabled ? 2 : 0)
                ...
                | (value.VolumeStep << VolumeShift) | (value.AimSensitivityStep << AimSensitivityShift);
        }
        ...
        public static GamePreferences Decode(int value)
        {
            if ((value & VersionFlag) != 0)
                return new GamePreferences((value & 1) != 0, (value & 2) != 0, (value & 4) != 0,
                    (value & 8) != 0, (value & 16) != 0, (value >> VolumeShift) & 15, (value >> AimSensitivityShift) & 15);
            if ((value & VolumeVersionFlag) != 0)
                return new GamePreferences((value & 1) != 0, (value & 2) != 0, (value & 4) != 0,
                    (value & 8) != 0, (value & 16) != 0, (value >> VolumeShift) & 15, 5);
