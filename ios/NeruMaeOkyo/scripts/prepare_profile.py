...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.nerumaeokyo")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "NeruMaeOkyo App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/NeruMaeOkyo_App_Store.mobileprovision"
