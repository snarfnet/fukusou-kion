...
enum DialogueBank {
    ...
    private static func candidates(for event: DialogueEvent, size: Int, streak: Int) -> [CompanionLine] {
        ...
        case .completed:
            return lines(event, .shy, [
                "すごい、全部正解！ 本当にかっこよかったよ♡",
                "最後まで解き切ったね。さすがだなあ♡",
                "全部埋まった！ 今日のあなた、すごく頼もしかったよ",
                "完璧だね。こんなに上手だとは思わなかった♡",
                "一問ずつ丁寧に解いてたの、ちゃんと見てたよ",
                "難しいところも諦めなかったね。えらい！",
                "全問正解、おめでとう。私までうれしくなっちゃった♡",
                "頭の回転が速くてびっくりした。すごいね",
                "きれいに全部埋まったね。今日はあなたの勝ち♡",
                "最後の一文字まで完璧。よく頑張りました",
                "一緒に解けて楽しかった。次も頼りにしてるね♡",
                "こんなに早く解けるなんて、ちょっと尊敬しちゃう"
            ])
        case .idle:
