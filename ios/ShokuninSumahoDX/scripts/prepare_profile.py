...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.shokuninsumahodx")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "ShokuninSumahoDX App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/ShokuninSumahoDX_App_Store.mobileprovision"
