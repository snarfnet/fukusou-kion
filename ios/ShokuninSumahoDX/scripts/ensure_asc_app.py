...
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "ShokuninSumahoDX")
APP_NAME = os.environ.get("APP_NAME", "職人スマホSuper DX")
APP_SKU = os.environ.get("APP_SKU", "shokunin-sumaho-super-dx-ios")
