...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=APNGStickerStudio CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_stale_certificates():
    ...
    for certificate in certificates:
        ...
        is_this_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        ...
        print(
            ...
            f"action={'delete' if should_delete else 'keep'}"
        )
