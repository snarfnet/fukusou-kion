...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "GhostFollower App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/GhostFollower_App_Store.mobileprovision"
