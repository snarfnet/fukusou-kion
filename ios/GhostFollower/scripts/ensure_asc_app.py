...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.ghostfollower")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "GhostFollower")
APP_NAME = os.environ.get("APP_NAME", "Ghost Follower")
APP_SKU = os.environ.get("APP_SKU", "ghost-follower-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret GHOST_FOLLOWER_APP_ID.")
        return None
