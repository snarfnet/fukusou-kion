...
WORK_DIR = Path(os.environ.get("SIGNING_WORK_DIR", "/tmp/ghost-follower-signing"))
...
CI_CERT_MARKERS = ("ghostfollower", "ghost follower")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=GhostFollower CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
