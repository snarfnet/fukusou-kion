...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "CellArtisan App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/CellArtisan_App_Store.mobileprovision"
