...
WORK_DIR = Path("/tmp/cell-artisan-signing")
...
CI_CERT_MARKERS = ("cellartisan", "cell artisan")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=CellArtisan CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_known_invalid_certificates():
    ...
    for certificate in certificates:
        ...
        is_cell_artisan_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        ...
        elif is_cell_artisan_ci_cert:
            reason = "CellArtisan CI certificate"
