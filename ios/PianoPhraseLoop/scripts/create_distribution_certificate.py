...
WORK_DIR = Path("/tmp/piano-phrase-loop-signing")
...
CI_CERT_MARKERS = ("pianophraseloop", "piano phrase loop")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=PianoPhraseLoop CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_known_invalid_certificates():
    ...
    for certificate in certificates:
        ...
        is_piano_phrase_loop_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        ...
        elif is_piano_phrase_loop_ci_cert:
            reason = "PianoPhraseLoop CI certificate"
        ...
        should_delete = (
            ...
            or is_piano_phrase_loop_ci_cert
