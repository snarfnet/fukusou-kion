...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "PianoPhraseLoop App Store")
PROFILE_FILENAME = PROFILE_NAME.replace(" ", "_").replace("/", "_")
PROFILE_PATH = Path.home() / f"Library/MobileDevice/Provisioning Profiles/{PROFILE_FILENAME}.mobileprovision"
