...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "BibleTypewriter App Store")
PROFILE_PATH = Path(os.environ.get(
    "PROFILE_PATH",
    str(Path.home() / "Library/MobileDevice/Provisioning Profiles/BibleTypewriter_App_Store.mobileprovision"),
))
