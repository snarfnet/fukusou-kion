...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.yakushotetsuzukinavi")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "YakushoTetsuzukiNavi")
APP_NAME = os.environ.get("APP_NAME", "役所手続きナビ")
APP_SKU = os.environ.get("APP_SKU", "yakusho-tetsuzuki-navi-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create it manually in App Store Connect, then set GitHub Secret YAKUSHO_TETSUZUKI_NAVI_APP_ID.")
        return None
