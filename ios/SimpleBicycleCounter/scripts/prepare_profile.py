...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.simplebicyclecounter")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "SimpleBicycleCounter App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/SimpleBicycleCounter_App_Store.mobileprovision"
