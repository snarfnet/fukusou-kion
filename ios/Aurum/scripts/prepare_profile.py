...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "Aurum App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/Aurum_App_Store.mobileprovision"
