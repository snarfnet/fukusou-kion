...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.aurum")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "Aurum")
APP_NAME = os.environ.get("APP_NAME", "Aurum 古の錬金帖")
APP_SKU = os.environ.get("APP_SKU", "aurum-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret AURUM_APP_ID.")
        return None
