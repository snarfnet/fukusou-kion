...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.simplevehiclecounter")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "SimpleVehicleCounter App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/SimpleVehicleCounter_App_Store.mobileprovision"
