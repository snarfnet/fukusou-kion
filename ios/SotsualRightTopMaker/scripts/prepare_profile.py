...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "SotsualRightTopMaker App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/SotsualRightTopMaker_App_Store.mobileprovision"
