...
BUNDLE_ID = os.environ.get("BUNDLE_ID", "com.tokyonasu.sotsualrighttopmaker")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "SotsualRightTopMaker")
APP_NAME = os.environ.get("APP_NAME", "卒アル右上メーカー")
APP_SKU = os.environ.get("APP_SKU", "sotsual-right-top-maker-ios")
