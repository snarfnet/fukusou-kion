...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "MensetsuIkuzo App Store")
PROFILE_FILE = PROFILE_NAME.replace(" ", "_").replace("/", "_")
PROFILE_PATH = Path.home() / f"Library/MobileDevice/Provisioning Profiles/{PROFILE_FILE}.mobileprovision"
