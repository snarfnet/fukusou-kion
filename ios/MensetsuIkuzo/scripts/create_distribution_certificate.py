...
WORK_DIR = Path("/tmp/mensetsu-ikuzo-signing")
...
CI_CERT_MARKERS = ("mensetsuikuzo", "mensetsu ikuzo")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=MensetsuIkuzo CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_known_invalid_certificates():
    ...
    for certificate in certificates:
        ...
        is_app_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        should_delete = (
