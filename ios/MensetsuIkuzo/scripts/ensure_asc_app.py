...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.mensetsuikuzo")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "MensetsuIkuzo")
APP_NAME = os.environ.get("APP_NAME", "面接行くぞい")
APP_SKU = os.environ.get("APP_SKU", "mensetsu-ikuzo-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret MENSETSU_IKUZO_APP_ID.")
        return None
