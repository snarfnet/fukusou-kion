...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.simpletrafficsurvey")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "SimpleTrafficSurvey App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/SimpleTrafficSurvey_App_Store.mobileprovision"
