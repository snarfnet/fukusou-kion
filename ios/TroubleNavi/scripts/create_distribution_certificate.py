...
WORK_DIR = Path(os.environ.get("SIGNING_WORK_DIR", "/tmp/trouble-navi-signing"))
...
CI_CERT_MARKERS = ("troublenavi", "trouble navi", "初動ナビ")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=TroubleNavi CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
