...
enum SourceDirectory {
    static let links: [String: SourceLink] = [
        "courtsDivorce": .init(id: "courtsDivorce", title: "裁判所: 夫婦(離婚等)", url: URL(string: "https://www.courts.go.jp/saiban/syurui/fuufu/index.html")!),
        ...
        "mlitMansionRules": .init(id: "mlitMansionRules", title: "国交省: マンション標準管理規約", url: URL(string: "https://www.mlit.go.jp/jutakukentiku/house/mansionkiyaku.html")!),
        "mlitMansionManage": .init(id: "mlitMansionManage", title: "国交省: マンション管理", url: URL(string: "https://www.mlit.go.jp/jutakukentiku/house/jutakukentiku_house_tk5_000052.html")!),
        "mankan": .init(id: "mankan", title: "マンション管理センター", url: URL(string: "https://www.mankan.or.jp/")!),
        "envWaste": .init(id: "envWaste", title: "環境省: 廃棄物等の処理", url: URL(string: "https://www.env.go.jp/recycle/waste/index.html")!),
        "consumer": .init(id: "consumer", title: "消費者庁: 消費者ホットライン188", url: URL(string: "https://www.caa.go.jp/policies/application/inquiry/")!),
        "labor": .init(id: "labor", title: "厚労省: 総合労働相談コーナー", url: URL(string: "https://www.mhlw.go.jp/general/seido/chihou/kaiketu/soudan.html")!),
        "harassment": .init(id: "harassment", title: "厚労省: 職場のハラスメント", url: URL(string: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/koyou_roudou/koyoukintou/seisaku06/index.html")!),
        "internet": .init(id: "internet", title: "法務省: インターネット人権侵害", url: URL(string: "https://www.moj.go.jp/JINKEN/jinken88.html")!),
