...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.dailyangel")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "DailyAngel App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/DailyAngel_App_Store.mobileprovision"
