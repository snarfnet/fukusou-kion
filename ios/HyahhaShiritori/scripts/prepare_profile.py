...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "HyahhaShiritori App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/HyahhaShiritori_App_Store.mobileprovision"
