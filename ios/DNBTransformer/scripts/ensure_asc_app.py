...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.chop170")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "DNBTransformer")
APP_NAME = os.environ.get("APP_NAME", "CHOP 170 - DnB Generator")
APP_SKU = os.environ.get("APP_SKU", "chop-170-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret DNB_TRANSFORMER_APP_ID.")
        return None
