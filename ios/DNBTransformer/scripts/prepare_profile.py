...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "CHOP170 App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/CHOP170_App_Store.mobileprovision"
