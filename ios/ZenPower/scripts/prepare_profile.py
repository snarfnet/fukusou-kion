...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.zenpower")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "ZenPower App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/ZenPower_App_Store.mobileprovision"
