...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "MasterShotCamera App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/MasterShotCamera_App_Store.mobileprovision"
