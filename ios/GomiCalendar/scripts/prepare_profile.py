...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "GomiCalendar App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/GomiCalendar_App_Store.mobileprovision"
