...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.gomicalendar")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "GomiCalendar")
APP_NAME = os.environ.get("APP_NAME", "ごみ日カレンダー")
APP_SKU = os.environ.get("APP_SKU", "gomi-calendar-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret GOMI_CALENDAR_APP_ID.")
        return None
