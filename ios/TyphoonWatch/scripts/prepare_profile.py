...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "TyphoonWatch App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/TyphoonWatch_App_Store.mobileprovision"
