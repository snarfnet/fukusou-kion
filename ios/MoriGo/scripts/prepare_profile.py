...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.gyaruothello")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "GyaruOthello App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/GyaruOthello_App_Store.mobileprovision"
