...
PROFILE_NAME = os.environ.get("PROFILE_NAME", "ChiebukuroHakase App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/ChiebukuroHakase_App_Store.mobileprovision"
