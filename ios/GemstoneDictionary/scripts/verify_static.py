...
def main() -> int:
    ...
    results.append(check("判定結果共有", "ShareLink" in content and "shareText(for candidate" in content and "shareText(for entry" in content and "天然石判定メモ" in content and "square.and.arrow.up" in content and "基準物: \\(referenceLabel)" in content and "基準物: \\(entry.referenceLabel)" in content))
