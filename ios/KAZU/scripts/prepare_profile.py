...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.sermonnotes")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "SermonNotes App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/SermonNotes_App_Store.mobileprovision"
