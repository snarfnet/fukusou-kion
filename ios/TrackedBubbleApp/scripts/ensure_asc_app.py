...
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "TrackedBubbleApp")
APP_NAME = os.environ.get("APP_NAME", "お目目キラキラ")
APP_SKU = os.environ.get("APP_SKU", "tracked-bubble-app-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret TRACKED_BUBBLE_APP_ID.")
        return None
