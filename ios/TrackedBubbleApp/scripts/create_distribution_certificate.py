...
WORK_DIR = Path("/tmp/tracked-bubble-app-signing")
...
INVALID_SERIALS = {
    ...
    "2602E4D6509F5F9442BD0D359A214749",
    "324611F6F0A7D9D2A4BC1075D9C3E69C",
    "85461EBA622AD263595C75873FCEDB6",
    "65D6A52449A9F9FEE91E5D3155C7BBDF",
    "29F47B0F55AB243A66F7CCD8CEC5A63E",
    "3863467E9C3EABBDF5228579144A67F3",
    "61BAE8F89B44A0A5AB9ADE5D69D82DFA",
    "7D81B167F9868FCCE27A2FCD71E5D97C",
    "76BFBC5E5100B8A55E7C72AD8A60DA2A",
    "105B4FD818243452B241C5DDA1F34165",
    "496273D50C0B147D40573F3906A28295",
    "1D4C8859010F64385A8B60FBC41522B2",
}
CI_CERT_MARKERS = ("trackedbubbleapp", "tracked bubble app")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=TrackedBubbleApp CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_known_invalid_certificates():
    ...
    for certificate in certificates:
        ...
        is_tracked_bubble_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        ...
        elif is_tracked_bubble_ci_cert:
            reason = "TrackedBubbleApp CI certificate"
