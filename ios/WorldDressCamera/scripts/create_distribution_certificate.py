...
WORK_DIR = Path("/tmp/world-dress-camera-signing")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=WorldDressCamera CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_known_invalid_certificates():
    ...
    for certificate in certificates:
        ...
        is_world_dress_camera_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        ...
        elif is_world_dress_camera_ci_cert:
            reason = "WorldDressCamera CI certificate"
        ...
        should_delete = (
            ...
            or is_world_dress_camera_ci_cert
