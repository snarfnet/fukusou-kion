...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.worlddresscamera")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "WorldDressCamera")
APP_NAME = os.environ.get("APP_NAME", "民族衣装カメラ")
APP_SKU = os.environ.get("APP_SKU", "world-dress-camera-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret WORLD_DRESS_CAMERA_APP_ID.")
        return None
