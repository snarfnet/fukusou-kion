...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.florastitch")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "FloraStitch")
APP_NAME = os.environ.get("APP_NAME", "Flora Stitch")
APP_SKU = os.environ.get("APP_SKU", "flora-stitch-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret FLORA_STITCH_APP_ID.")
        return None
