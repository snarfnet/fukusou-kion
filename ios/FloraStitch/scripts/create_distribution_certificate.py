...
WORK_DIR = Path("/tmp/flora-stitch-signing")
...
CI_CERT_MARKERS = ("florastitch", "flora stitch")
...
def generate_csr():
    ...
    run(
        [
            ...
            str(CSR_PATH),
            "-subj",
            "/CN=FloraStitch CI Distribution/O=TokyoNasu/C=JP",
        ]
    )
...
def delete_known_invalid_certificates():
    ...
    for certificate in certificates:
        ...
        is_flora_stitch_ci_cert = any(marker in names for marker in CI_CERT_MARKERS)
        ...
        if REPLACE_DISTRIBUTION_CERTIFICATE:
            ...
            reason = "FloraStitch CI certificate"
