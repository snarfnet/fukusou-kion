...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.tsuchinokofinder")
PROFILE_NAME = os.environ.get("PROFILE_NAME", "TsuchinokoFinder App Store")
PROFILE_PATH = Path.home() / "Library/MobileDevice/Provisioning Profiles/TsuchinokoFinder_App_Store.mobileprovision"
