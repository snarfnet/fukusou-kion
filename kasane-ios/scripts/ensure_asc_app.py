...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.kasane")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "KASANE")
APP_NAME = os.environ.get("APP_NAME", "KASANE")
APP_SKU = os.environ.get("APP_SKU", "kasane-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("Create the app manually in App Store Connect, then set GitHub Secret KASANE_APP_ID.")
        return None
