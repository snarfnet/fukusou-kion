...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.sokosokojikan")
BUNDLE_NAME = os.environ.get("BUNDLE_NAME", "SokosokoJikan")
APP_NAME = os.environ.get("APP_NAME", "そこそこ時間を潰せる")
APP_SKU = os.environ.get("APP_SKU", "sokosoko-jikan-ios")
...
def ensure_app(bundle):
    ...
    try:
        ...
        print("App Store Connectでアプリを作成してから、Workflowを再実行してください。")
        return None
